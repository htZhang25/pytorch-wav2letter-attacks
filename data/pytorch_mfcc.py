...
class MFCC(torch.nn.Module):
    def __init__(self,samplerate=16000,winlen=0.01,winstep=0.005,numcep=13,nfilt=20,nfft=512,lowfreq=0,highfreq=None,preemph=0,ceplifter=22,appendEnergy=False):
    ...
    def get_filterbanks(self):
        ...
        rtn = torch.tensor(fbank.T,dtype=self.tensor_type).to(self.torch_device)
        return rtn
